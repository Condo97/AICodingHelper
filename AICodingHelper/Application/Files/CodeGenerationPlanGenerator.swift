...
class CodeGenerationPlanGenerator {
    ...
    func generatePlan(authToken: String, openAIKey: String?, model: GPTModels, instructions: String, rootFilepath: String, selectedFilepaths: [String]) async throws -> PlanCodeGenerationFC? {
        ...
        return try await planCodeGeneration(
            ...
            model: model,
            input: input,
            systemMessage: CodeGenerationPlanGenerator.systemMessage)
    }
    
    func planCodeGeneration(authToken: String, openAIKey: String?, model: GPTModels, input: String, systemMessage: String) async throws -> PlanCodeGenerationFC? {
