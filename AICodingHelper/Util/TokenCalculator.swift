            ...
            for step in codeGenerationPlan.planFC.steps {
                ...
                case .edit:
                    taskGroup.addTask {
                        ...
                        if let additionalInput = step.referenceFilepaths?.compactMap({FilePrettyPrinter.getFileContent(relativeFilepath: $0, rootFilepath: codeGenerationPlan.rootFilepath)}).joined(separator: "\n") {
                            do {
